...
sum_val = sqrt(sum(FeatMat1.^2));
for n = 1:size(FeatMat1, 1)
    FeatMat1(n, :) = FeatMat1(n, :)./sum_val;
end

sum_val = sqrt(sum(FeatMat2.^2));
for n = 1:size(FeatMat2, 1)
    FeatMat2(n, :) = FeatMat2(n, :)./sum_val;
end
